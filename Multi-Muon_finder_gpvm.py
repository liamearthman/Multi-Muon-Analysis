...
root_pattern="/pnfs/nova/persistent/production/exotics_dropbox/2/000129/12942/*.root" # all the root files in the data directory
...
for file in root_files:
    with uproot.open(file) as f:
        # will need to change how these are named
...
with open("muon_events.txt", "w") as f:
    for run, subrun, event, size in double_list:
        f.write(f"{run} {subrun} {event} {size}\n")